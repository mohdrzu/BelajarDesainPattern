...
kita harus memperbarui di beberapa tempat, yang dapat berpotensi menyebabkan kesalahan dan membutuhkan waktu yang lebih lama.
...
![hasil output](src/v_three/output-sc.png)
